    ...
    >
      <div className="navbar dark:bg-slate-900 dark:text-white">
        <div className="navbar-start">
          ...
          <Link to="/" className="text-2xl font-bold cursor-pointer"> {/* Cambiar a Link */}
            bookStore
          </Link>
        </div>
        <div className="navbar-end space-x-3">
          ...
          {authUser ? (
            ...
            <div className="">
              <a
                className="bg-slate-900 text-white px-3 py-2 rounded-md hover:bg-slate-700 duration-300 cursor-pointer"
                onClick={() =>
